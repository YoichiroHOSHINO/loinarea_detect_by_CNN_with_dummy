...
for i in tqdm(range(10)):
    ...
    # 黒塗りの脂肪領域(楕円形）を作製
    img = cv2.ellipse(img, ((ovaloutcenterx,ovaloutcentery), (outrangev, outrangeh), outangle), np.float(0), thickness=-1)
    ...
    # 白塗りのロース芯画像楕円１を作製
    img = cv2.ellipse(img, ((ovalloin1centerx,ovalloin1centery), (loin1rangev, loin1rangeh), loin1angle), np.float(255), thickness=-1)
    ...
    # 白塗りのロース芯画像楕円２を作製
    img = cv2.ellipse(img, ((ovalloin2centerx,ovalloin2centery), (loin2rangev, loin2rangeh), loin2angle), np.float(255), thickness=-1)
    ...
    bwimg = cv2.ellipse(bwimg, ((ovalloin1centerx,ovalloin1centery), (loin1rangev, loin1rangeh), loin1angle), 255, thickness=-1)
    bwimg = cv2.ellipse(bwimg, ((ovalloin2centerx,ovalloin2centery), (loin2rangev, loin2rangeh), loin2angle), 255, thickness=-1)
